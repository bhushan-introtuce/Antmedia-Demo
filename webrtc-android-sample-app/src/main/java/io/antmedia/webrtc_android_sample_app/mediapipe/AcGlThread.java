 ...
 * context.
 */
public class AcGlThread extends Thread {
    private static final String TAG = "AcGlThread";
    private static final String THREAD_NAME = "mediapipe.glutil.AcGlThread";
    ...
    protected int bGframebuffer = 0;

    /**
     * Creates a AcGlThread.
     *
     ...
     */
    public AcGlThread(@Nullable Object parentContext) {
     ...
     *     default ones.
     */
    public AcGlThread(@Nullable Object parentContext, @Nullable int[] additionalConfigAttributes) {
    ...
    public void bGbindFramebuffer(int texture, int width, int height){
        GLES20.glBindFramebuffer(GLES20.GL_FRAMEBUFFER, bGframebuffer);
        GLES20.glFramebufferTexture2D(
                GLES20.GL_FRAMEBUFFER,
                GLES20.GL_COLOR_ATTACHMENT0,
                GLES20.GL_TEXTURE_2D,
    ...
    public void prepareGl() {
        ...
        GLES20.glGenFramebuffers(2, values, 0);
        framebuffer = values[0];
        bGframebuffer = values[1];
    }
    ...
    public void releaseGl() {
        if (framebuffer != 0) {
            ...
            values[1] = bGframebuffer;
            GLES20.glDeleteFramebuffers(2, values, 0);
